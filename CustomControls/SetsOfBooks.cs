...
namespace BookDealer.CustomControls
{
    public partial class SetsOfBooks : UserControl
    {
        ...
        private string table = "setsofbooks";
        private string tableID = "setid";
        ...
        private void UpdateSetsDB_Click(object sender, EventArgs e)
        {
            ReLoadData();
        }
        ...
        {
            string s = Interaction.InputBox("Save as..", "Save", "SetsOfBooks.txt");
            SavetoFile(s);
        }
    }
}
